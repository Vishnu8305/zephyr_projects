...
struct _isr_table_entry __sw_isr_table _sw_isr_table[82] = {
	...
	{(const void *)0x8003e83, (ISR)0x8000e19}, /* 6 */
	{(const void *)0x8003e81, (ISR)0x8000e19}, /* 7 */
	{(const void *)0x8003e7f, (ISR)0x8000e19}, /* 8 */
	{(const void *)0x8003e7d, (ISR)0x8000e19}, /* 9 */
	{(const void *)0x8003e7b, (ISR)0x8000e19}, /* 10 */
	...
	{(const void *)0x8003e79, (ISR)0x8000e19}, /* 23 */
	...
	{(const void *)0x8003e77, (ISR)0x8000e19}, /* 40 */
